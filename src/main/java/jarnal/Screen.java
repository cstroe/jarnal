...
public class Screen extends JPanel implements Runnable{
	...
	public Screen(Jarnal.JrnlPane jp, boolean image, boolean entireScreen){
...
class scrMouseListener extends MouseAdapter {
	...
	public scrMouseListener(JFrame frame, Screen js){
		f = frame;
		j = js;
	}
...
class scrMouseMotionListener extends MouseMotionAdapter {
	...
	public scrMouseMotionListener(Screen js){
		j = js;
	}
