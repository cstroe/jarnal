...
public class Tools{
	...
	public static String getBasepath(){
		String myster = Tools.class.getClassLoader().getSystemResource("jarnal/Jarnal.class").toString();
		myster = Tools.replaceAll(myster, "jarnal/Jarnal.class", "");
		myster = Tools.replaceAll(myster, "file:", "");
		myster = Tools.replaceAll(myster, "jar:/", "");
		myster = Tools.replaceAll(myster, "jarnal.jar!/", "");
		myster = Tools.replaceAll(myster, "%20", " ");
	...
	public static Tools getTool(String y){
	...
	public penDialogListener showDialog(JFrame jf, Tools curPen, Tools defPen, Tools defHigh, Tools defBut, Jarnal jarn){
	...
	class penDialogListener implements ActionListener {
		...
		public penDialogListener showDialog(JFrame jf, Tools curPen, Tools defPen, Tools defHigh, Tools defBut, Tools parent, Jarnal jarn){
			this.curPen = curPen;
			this.defPen = defPen;
...
class HtmlPost {
	...
	public HtmlPost(String xserver, String xmessage, Pages xjpages, Hashtable xht, String xconf, boolean xurlencoded){
	...
	private void writeFile(String key, String fname, String op){
		...
		if(!urlencoded){
			...
			try {
				...
				else pages.netWrite(out, op, conf, withBorders);
			...
			prn = key + "=";
			ByteArrayOutputStream baost = new ByteArrayOutputStream();
			pages.netWrite(baost, op, conf, withBorders);
